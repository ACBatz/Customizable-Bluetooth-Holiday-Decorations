...
public class BluetoothSerialService {
    ...
    private synchronized void setState(int state) {
        Log.i("state change", mState + " -> " + state);
        mState = state;
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            Log.i("ConnectThread", device.getAddress());
            mmDevice = device;
            ...
            try {
                if ( mAllowInsecureConnections ) {
                    ...
                    */
                    // I was having better success with this means of establishing an insecure connection
                    tmp = device.createInsecureRfcommSocketToServiceRecord(SerialPortServiceClass_UUID);
                    Log.i("SocketIn", tmp.toString());
                }
                else {
                    tmp = device.createRfcommSocketToServiceRecord( SerialPortServiceClass_UUID );
                    Log.i("SocketSe", tmp.toString());
                }
            } catch (Exception e) {
